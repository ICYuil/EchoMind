...
@Table(name = "interview_sessions", indexes = {
        ...
        @Index(name = "idx_interview_session_user_created", columnList = "userId,created_at")
})
public class InterviewSessionEntity {
    ...
    private String learningPlanJson;
    ...
    public String getLearningPlanJson(){return learningPlanJson;}
    public void setLearningPlanJson(String learningPlanJson){this.learningPlanJson=learningPlanJson;}

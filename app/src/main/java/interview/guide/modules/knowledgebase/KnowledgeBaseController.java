...
import interview.guide.modules.knowledgebase.service.*;
...
public class KnowledgeBaseController {
    ...
    public Result<List<KnowledgeBaseListItemDTO>> getAllKnowledgeBases(
        ...
        List<KnowledgeBaseListItemDTO>list=listService.listKnowledgeBases(status,sortBy);
//        List<String>baseNames=list.stream().map(KnowledgeBaseListItemDTO::name).collect(Collectors.toList());
//        for(String baseName:baseNames){
//            if(!testQuestionRepository.existsByDatabaseName(baseName)){
//                List<TestQuestionEntity>list1=testQuestionService.getTestQuestions();
//                testQuestionRepository.saveAll(list1);
//            }
//        }
